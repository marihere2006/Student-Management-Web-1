...
<head>
    ...
    <meta name="description" content="View all student records in the Student Management System.">
    <title>View Students — StudentHub</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            ...
            <li><a href="student?action=view" class="active"><span class="nav-icon">&#128065;</span> <span class="nav-label">Students</span></a></li>
    ...
    <main class="container">
        ...
        <div class="page-header fade-in">
            ...
            <p>View all registered students (read-only).</p>
        </div>
